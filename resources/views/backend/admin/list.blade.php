                            ...
                            @foreach($adminList as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{--{{ asset('admin/admin_manager/delete/'.$item->id) }}--}}" onclick="return confirm('Do you want to delete this category?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
