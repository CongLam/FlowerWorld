                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($adminList as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('admin/customer_manager/edit/'.$item->id) }}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Sửa</a>
                                        <a href="{{ asset('admin/customer_manager/delete/'.$item->id) }}" onclick="return confirm('Bạn chắc chắn muốn xóa khách hàng?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
