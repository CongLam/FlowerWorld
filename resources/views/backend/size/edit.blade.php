...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Size Product</h1>
        </div>
    </div><!--/.row-->
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <input type="submit" name="edit_btn" class="form-control btn btn-primary" value="Edit size" onclick="return confirm('Do you want to add new size?')">
                        </div>
                        <div class="form-group">
                            <a href="{{ asset('admin/size') }}" class="form-control btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
